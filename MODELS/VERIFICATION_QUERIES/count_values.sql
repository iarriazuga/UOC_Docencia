...
5104156			DB_UOC_PROD.DDP_DOCENCIA.FACT_RECURSOS_APRENENTATGE_EVENTS_AGG
16702552		DB_UOC_PROD.DDP_DOCENCIA.FACT_RECURSOS_APRENENTATGE_EVENTS

16702552		DB_UOC_PROD.DDP_DOCENCIA.FACT_RECURSOS_APRENENTATGE_EVENTS
13662337		DB_UOC_PROD.DDP_DOCENCIA.STAGE_LIVE_EVENTS_FLATENED_RA
...
219067			DB_UOC_PROD.DDP_DOCENCIA.DIM_RECURSOS_APRENENTATGE
1244869			DB_UOC_PROD.DD_OD.DIM_PERSONA

5104156			DB_UOC_PROD.DDP_DOCENCIA.POST_DADES_ACADEMIQUES_RA
312270			DB_UOC_PROD.STG_DADESRA.GAT_PERSONAS_ASIGNATURAS
...
13662337		DB_UOC_PROD.DDP_DOCENCIA.STAGE_LIVE_EVENTS_FLATENED_RA
21504211		DB_UOC_PROD.STG_DADESRA.LIVE_EVENTS_CALIPER_DUMMY

7			    DB_UOC_PROD.DDP_DOCENCIA.STAGE_RECURSOS_APRENENTATGE_COCO_CLEAN_PROCEDURE
116893			DB_UOC_PROD.DDP_DOCENCIA.STAGE_RECURSOS_APRENENTATGE_COCO_PRODUCT_MODULS
...
SELECT 
    ...
    , column_name || ' ' || data_type || ' comment ' ||comment  as agente
FROM information_schema.columns
WHERE 1=1 
    and comment is not null
    AND table_catalog = 'DB_UOC_PROD'
    AND table_schema in (
        'DD_OD'
        ,'DDP_DOCENCIA'
        ,'STG_DADESRA'
    ...
    AND table_name IN (
        ...
        ,'FACT_RECURSOS_APRENENTATGE_EVENTS_AGG'
        ,'LK_IDIOMA_2'
        ,'POST_DADES_ACADEMIQUES_RA'
        ,'STAGE_DADES_ACADEMIQUES_COCO'
        ,'STAGE_DADES_ACADEMIQUES_DIMAX'
        ,'STAGE_LIVE_EVENTS_FLATENED_RA'
        ,'STAGE_RECURSOS_APRENENTATGE_COCO_CLEAN_PROCEDURE'
        ,'STAGE_RECURSOS_APRENENTATGE_COCO_PRODUCT_MODULS'
        ,'STAGE_RECURSOS_APRENENTATGE_DIMAX'
        ,'AUTORS_ELEMENT_FORMACIO'
        ,'AUTORS_IDIOMA_PRODUCTE_I18N'
        ,'AUTORS_MODUL'
        ,'AUTORS_PERIODE'
        ,'AUTORS_PRODUCTE'
        ,'AUTORS_PRODUCTES_VERSIONS'
        ,'AUTORS_SUPORT_PRODUCTE_I18N'
        ,'AUTORS_TIPUS_TRAMESA_I18N'
        ,'AUTORS_VERSIO'
        ,'DIMAX_ITEM_DIMAX'
        ,'DIMAX_RECURS_INFO_EXTRA'
        ,'DIMAX_RESOFITE_PATH'
        ,'DIMAX_V_RECURS'
        ,'GAT_PERSONAS_ASIGNATURAS'
        ,'LIVE_EVENTS_CALIPER_DUMMY'
        ,'GAT_ASIG_SEMESTRES'      
    )
