...
CREATE OR REPLACE TABLE DB_UOC_PROD.DDP_DOCENCIA.STAGE_DADES_ACADEMIQUES_COCO_2 (
...
CREATE OR REPLACE PROCEDURE DB_UOC_PROD.DDP_DOCENCIA.STAGE_DADES_ACADEMIQUES_COCO_2_LOADS()
...
BEGIN
    ...
    -- MERGE 2: Volcado de registros
    MERGE INTO DB_UOC_PROD.DDP_DOCENCIA.STAGE_DADES_ACADEMIQUES_COCO_2
    USING (
    ...
    ON (
        ALIAS_QUERY_IN.DIM_ASSIGNATURA_KEY = DB_UOC_PROD.DDP_DOCENCIA.STAGE_DADES_ACADEMIQUES_COCO_2.DIM_ASSIGNATURA_KEY
        AND ALIAS_QUERY_IN.DIM_SEMESTRE_KEY = DB_UOC_PROD.DDP_DOCENCIA.STAGE_DADES_ACADEMIQUES_COCO_2.DIM_SEMESTRE_KEY
        AND ALIAS_QUERY_IN.DIM_RECURSOS_APRENENTATGE_KEY = DB_UOC_PROD.DDP_DOCENCIA.STAGE_DADES_ACADEMIQUES_COCO_2.DIM_RECURSOS_APRENENTATGE_KEY
        AND ALIAS_QUERY_IN.CODI_RECURS = DB_UOC_PROD.DDP_DOCENCIA.STAGE_DADES_ACADEMIQUES_COCO_2.CODI_RECURS
    )
    WHEN MATCHED AND (
        ALIAS_QUERY_IN.DIM_ASSIGNATURA_KEY <> DB_UOC_PROD.DDP_DOCENCIA.STAGE_DADES_ACADEMIQUES_COCO_2.DIM_ASSIGNATURA_KEY
        OR ALIAS_QUERY_IN.DIM_SEMESTRE_KEY <> DB_UOC_PROD.DDP_DOCENCIA.STAGE_DADES_ACADEMIQUES_COCO_2.DIM_SEMESTRE_KEY
        OR ALIAS_QUERY_IN.DIM_RECURSOS_APRENENTATGE_KEY <> DB_UOC_PROD.DDP_DOCENCIA.STAGE_DADES_ACADEMIQUES_COCO_2.DIM_RECURSOS_APRENENTATGE_KEY
        OR ALIAS_QUERY_IN.CODI_RECURS <> DB_UOC_PROD.DDP_DOCENCIA.STAGE_DADES_ACADEMIQUES_COCO_2.CODI_RECURS
    ) THEN
        UPDATE SET
            DIM_ASSIGNATURA_KEY = ALIAS_QUERY_IN.DIM_ASSIGNATURA_KEY,
            DIM_SEMESTRE_KEY = ALIAS_QUERY_IN.DIM_SEMESTRE_KEY,
            DIM_RECURSOS_APRENENTATGE_KEY = ALIAS_QUERY_IN.DIM_RECURSOS_APRENENTATGE_KEY,
            CODI_RECURS = ALIAS_QUERY_IN.CODI_RECURS,
    ...
    VALUES (
        ...
        'DB_UOC_PROD.DDP_DOCENCIA.STAGE_DADES_ACADEMIQUES_COCO_2',
        CURRENT_USER(),
        :start_time,
        :execution_time,
        'DB_UOC_PROD.DDP_DOCENCIA.STAGE_DADES_ACADEMIQUES_COCO_2 Success'
    );
...
-- CALL DB_UOC_PROD.DDP_DOCENCIA.STAGE_DADES_ACADEMIQUES_COCO_2_LOADS();
