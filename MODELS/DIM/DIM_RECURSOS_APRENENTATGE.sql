...
With dim_coco_productes_moduls AS ( 
    ...
    SELECT
        ...
        , BAIXA   -- BAIXA aprobado con xabi : no se visualiza ( similar a ocultar) para no romper integridad no se muestra  
        ...
        , descripcio_idioma_recurs  -- Options dimax: en / es / ca
