...
*/
CREATE OR REPLACE TABLE DB_UOC_PROD.DDP_DOCENCIA.F_LIVE_EVENTS_FLATENED_TRANSFORMED AS 
...
with temp_table as (
    ...
    from DB_UOC_PROD.DDP_DOCENCIA.F_LIVE_EVENTS_FLATENED  -- 8,741,384 vs 123,019
